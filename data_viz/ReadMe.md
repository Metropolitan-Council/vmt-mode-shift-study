...
2. select\_congested\_car\_data - When creating the car routes, we create routes for all times of day reflecting different congestion levels.  This script selects the appropriate times of day and writes them all to one file.  
