...
Relations = require("lualib/relations")
...
function setup()
  ...
  return {
    ...
    speeds = Sequence {
      highway = {
        motorway        = 90, -- 56 mph
        motorway_link   = 45, -- 28 mph
        trunk           = 85, -- 53 mph
        trunk_link      = 40, -- 25 mph
        primary         = 65, -- 40 mph
        primary_link    = 30, -- 19 mph
        secondary       = 55, -- 34 mph
        secondary_link  = 25, -- 16 mph
        tertiary        = 40, -- 25 mph
        tertiary_link   = 20, -- 12 mph
        unclassified    = 25, -- 16 mph
        residential     = 25, -- 16 mph
        living_street   = 10, -- 6 mph
        service         = 15  -- 9 mph
      }
    },
