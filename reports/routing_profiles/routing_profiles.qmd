...
Upslopes slow a bicyclist down. Bicyclists travel faster than normal on downslopes, but this effect is smaller than the slowdown from upslopes [@parkin_design_2010]. Bicyclists avoid upslopes more than the time difference would suggest, with @broach_where_2012 finding that cyclists are willing to travel up to 1.72 km on flat ground to avoid 1 km of ground with a 2-4% slope.[^morethanspeed] Cyclists are extremely averse to steeper slopes, willing to travel up to 3.9 km on flat ground to avoid 1 km with slopes 4-6%, and 12.1 km to avoid slopes 6% or more. @hood_gpsbased_2011 find that cyclists will travel 0.59 km to avoid 10m of elevation gain. While the values are not directly comparable to, this implies that people are more averse to 2-4% slopes, similarly averse to 4-6% slopes, and considerably less averse to steeper slopes, relative to @broach_where_2012.[^comparison] There may be regional variations as well; @hood_gpsbased_2011's model was estimated in hilly San Francisco, while @broach_where_2012's was estimated in relatively flatter Portland, Oregon.
